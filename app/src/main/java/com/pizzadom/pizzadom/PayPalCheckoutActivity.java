...
import com.pizzadom.pizzadom.jsonEntityObjects.PaymentResponseObject;
import com.pizzadom.pizzadom.jsonEntityObjects.ServerObject;
import com.pizzadom.pizzadom.network.GsonRequest;
import com.pizzadom.pizzadom.network.VolleySingleton;
...
public class PayPalCheckoutActivity extends AppCompatActivity {
    ...
    private static final String SERVER_PATH = "http://192.168.1.70/Paymentverification/Token.php";
